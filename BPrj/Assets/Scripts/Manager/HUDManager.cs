...
public class HUDManager : MonoBehaviour
{
    ...
    public void ShowInspectImage(Sprite sprite, IPlayerInteractable script)
    {
        ...
        IsInspecting = true;
        SetInteractActionText(interactActionText.text.Substring(0, interactActionText.text.IndexOf(')') + 1) + " Zavшнt");
    }
    ...
    // == Thanks for playing ====================
    [Header("WIN Ц Thanks for playing")]
